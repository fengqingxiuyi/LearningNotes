...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    // 搜索结果列表
    self.navFocus = true;
    var decodeQValue = decodeURIComponent(weex.config.q);
    shopModal.toast({ message: weex.config.q });
    if (decodeQValue !== '') {
      self.navFocus = false;
      ...
      self.qValue = decodeQValue;
    }
    var decodeKeyWordValue = decodeURIComponent(weex.config.keyword);
    if (decodeKeyWordValue !== '') {
      self.keywordValue = decodeKeyWordValue;
    }
