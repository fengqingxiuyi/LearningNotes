...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    if (weex.config.env.platform.toLowerCase() === 'ios') {
      self.navHeight = self.getAbsHeight(128);
    } else {
      self.navHeight = self.getAbsHeight(88);
    }
    self.tabHeight = 81;
    ...
    if (weex.config.q) {
      ...
      self.qValue = weex.config.q;
    }
    if (weex.config.keyword) {
      self.keywordValue = weex.config.keyword;
    }
  ...
  methods: {
    ...
    search: function search() {
      ...
      var data = {
        ...
        shopId: self.shopId,
        keyword: decodeURIComponent(self.keywordValue),
        q: decodeURIComponent(self.qValue),
        sort: self.sortValue
      };
      self.fetch({
        method: 'GET',
    ...
    onInput: function onInput() {
      ...
      if (self.navInputContent.trim() !== '') {
        var data = {
          word: decodeURIComponent(self.navInputContent.trim())
        };
        self.fetch({
          method: 'GET',
          url: '/api/sug',
      ...
      if (result.isSelected) {
        ...
        self.fetch({
          ...
          if (response.isSuccess) {
            ...
            shopBase.userTrack({ key: 'detail_unselect', params: {} });
          } else {
            shopModal.toast({ message: response.msg });
          }
        });
        ...
        self.fetch({
          ...
          if (response.isSuccess) {
            ...
            shopBase.userTrack({ key: 'detail_add_goods', params: {} });
          } else {
            shopModal.toast({ message: response.msg });
          }
        });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.isWeb) ? _c('spon-header', {
  ...
  }), (_vm.resultList.length === 0) ? _c('div', {
    ...
    style: {
      top: (_vm.navHeight + _vm.tabHeight) + 'px'
    }
  }, [_c('list', {
